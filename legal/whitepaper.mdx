...
| XRP | XRP | Swap, user holdings |
| Solana | SOL | Swap, user holdings |
| Cardano | ADA | Swap, user holdings |
| Litecoin | LTC | Swap, user holdings |
| PancakeSwap | CAKE | Staking (PancakeSwap protocol) |
| Chainlink | LINK | Swap, user holdings |
| Uniswap | UNI | Swap, user holdings |
| Aave | AAVE | Swap, user holdings |
| Radiant | RDNT | Swap, user holdings |
| Avalanche | AVAX | Swap, user holdings |
| TRON | TRX | Swap, user holdings |
| Stellar | XLM | Swap, user holdings |
| Dogecoin | DOGE | Swap, user holdings |
...
**Supported pairs:** All assets (INKY, BTCB, ETH, XRP, SOL, ADA, LTC, CAKE, LINK, UNI, AAVE, RDNT, AVAX, TRX, XLM, DOGE, SHIB) trade against USDT. Both Buy (USDT to asset) and Sell (asset to USDT) are available.
