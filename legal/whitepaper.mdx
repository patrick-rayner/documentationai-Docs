...
**Supported pairs:** All 7 assets (INKY, BTCB, ETH, CAKE, BSW, RDNT, SHIB) trade against USDT. Both Buy (USDT to asset) and Sell (asset to USDT) are available.
...
Updated and digitally signed versions will be available at [https://inkryptus.com/whitepaper](https://inkryptus.com/whitepaper), accompanied by a public SHA-256 hash for integrity verification.
