...
All 7 assets trade through USDT. The USDT itself is the central pair and does not appear as a tradeable asset in the Swap screen.

All 7 assets support both Buy (USDT→asset) and Sell (asset→USDT).
...
See [Fees](/introduction/fees) for the full fee structure, including commission distribution.
...
<Columns cols="2">
  <Card title="Buy, Sell & Send FAQ: Common questions about swaps, AMM pricing, and transfers" icon="help-circle" href="/help-center/faq/buy-sell-send">
    Answers to frequently asked questions about swapping assets.
  </Card>
  <Card title="Swap Tutorial: Step-by-step guide to buy and sell assets" icon="book-open" href="/help-center/tutorials/buy-sell">
...
<Columns cols="2">
  <Card title="Buy and Sell on Inkryptus" icon="globe" href="https://inkryptus.com/swap">
    Visit the swap page on inkryptus.com.
  </Card>
  <Card title="AMM and Liquidity Pools" icon="book-open" href="https://inkryptus.com/learn/amm-and-liquidity-pools">
    Understand how automated market makers and liquidity pools work.
  </Card>
</Columns>
