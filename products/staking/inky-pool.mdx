...
---
<!-- IMAGE SUGGESTION: Diagram showing staking flow: User deposits INKY → Staking Contract → Daily emission (1% or 10K cap) → Rewards distributed proportionally → User harvests to wallet. Show 25% performance fee deduction. -->
...
| Current staked | ~6,775,754 INKY (as of April 13, 2026) |
...
| 6 months | Yes | - | - | Discontinued (V2.8.0) |
| 24 months | Yes | - | - | Discontinued (V2.8.0) |

Plans discontinued in V2.8.0 are no longer available for new contracts. Existing contracts on those terms continue running until maturity.
...
**Example 1** (below cap): 500,000 INKY staked total.
- 1% of 500,000 = 5,000 INKY. Below the 10K cap.
- Daily emission: **5,000 INKY**, split proportionally.

**Example 2** (cap applies): 2,000,000 INKY staked total.
- 1% of 2,000,000 = 20,000 INKY. Exceeds the 10K cap.
- Daily emission: **10,000 INKY** (cap applies), split proportionally.

**Implication**: as total staked volume grows, the effective daily rate per INKY decreases. Early participants in smaller pools receive a higher proportional share.
