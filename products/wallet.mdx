...
| --- | --- | --- | --- | --- |
| INKY | INKY | BNB Smart Chain | Native token | Staking, Arena, buy/sell, fee payment |
| Tether | USDT | BNB Smart Chain | Stablecoin | Staking, buy/sell, fiat on-ramp |
| Bitcoin | BTCB | BNB Smart Chain | Major | Trading, user holdings |
| Ethereum | ETH | BNB Smart Chain | Major | Trading, user holdings |
| PancakeSwap | CAKE | BNB Smart Chain | DeFi | Staking (PancakeSwap protocol) |
| Biswap | BSW | BNB Smart Chain | DeFi | Trading, user holdings |
| Radiant | RDNT | BNB Smart Chain | DeFi | Trading, user holdings |
| Shiba Inu | SHIB | BNB Smart Chain | Meme | Trading, user holdings |
| BinaryX | BNX | BNB Smart Chain | GameFi | Trading, user holdings |
