...
Swap handles only the internal asset conversion. For depositing USDT into your wallet (via external wallet, exchange, or fiat provider), see [Wallet](/products/wallet). For sending assets to an external address, see [Wallet — Withdrawals](/products/wallet#withdrawals).
...
<!-- IMAGE SUGGESTION: Diagram showing Swap scope: USDT in center, 8 assets around it with bidirectional arrows. Deposit and Withdrawal arrows pointing into/out of the USDT node, labeled "See Wallet". -->
