...
This model applies uniformly to all fee types: subscription, transaction, performance, and Arena games. For details on each fee, see [Fees](/legal/fees).
...
<Tabs>
  ...
  <Tab title="Performance" icon="trending-up">
    ...
    **Eligibility:** To receive performance fee commissions on a given asset, the IBO must hold an active staking position in that same asset. IBOs without active staking in the relevant asset do not receive performance fee commissions for that asset.
...
<Columns cols="3">
  <Card title="Fees" icon="percent" href="/legal/fees" horizontal={true}>
    Complete fee schedule: transaction, performance, and subscription.
  </Card>
  <Card title="Performance Fee" icon="trending-up" href="/legal/fees#performance-fee" horizontal={true}>
    25% daily profit fee: calculation and distribution.
  </Card>
  <Card title="Arena" icon="target" href="/features/arena" horizontal={true}>
    Coin Flip game mechanics and embedded fee structure.
  </Card>
</Columns>
