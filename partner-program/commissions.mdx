...
This model applies uniformly to all fee types: subscription, transaction, performance, and Arena games. For details on each fee, see [Fees](/introduction/fees).
...
<Columns cols="3">
  <Card title="Fees" icon="percent" href="/introduction/fees" horizontal={true}>
    Complete fee schedule: transaction, performance, and subscription.
  </Card>
  <Card title="Performance Fee" icon="trending-up" href="/introduction/fees#performance-fee" horizontal={true}>
